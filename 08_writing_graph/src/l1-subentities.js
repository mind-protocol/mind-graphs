...
export function promoteSubentity(entity, highLevelCount, options = {}) {
  ...
  return { promoted: true, entity: { ...copy(entity), level: "high", status: "active", name: materialized.name, narrativeIds: materialized.narratives.map(n => n.id) }, score, threshold, narratives: materialized.narratives, relations: materialized.relations };
}
